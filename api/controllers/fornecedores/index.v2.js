...
const Fornecedor = require('../../models/fornecedores/index.v2')
const { FormatsFornecedor } = require('../../../formats')

const fornecedores = require('express').Router()
const produtos = require('./produtos.v2')

module.exports = router => {
    router.use('/v2/fornecedores', fornecedores) // agrupamento de fornecedores
